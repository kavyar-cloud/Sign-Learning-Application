  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
       ...
       <li class="treeview"><a class="app-menu__item active" href="appoinmentrequest.php" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Book appointment</span><i class="treeview-indicator fa fa-angle-right"></i></a>
...
{ $q=$_SESSION['username'];
            ...
            $sql = "INSERT INTO send_request (sender_id,user_id) VALUES ('$q','$w')";
