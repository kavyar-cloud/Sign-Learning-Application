...
<!-- <li class="treeview"><a class="app-menu__item" href="chat.php" data-toggle="treeview"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Chat</span><i class="treeview-indicator fa fa-angle-right"></i></a> -->
<li><a class="app-menu__item" href="chat.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Chat</span></a></li>
