...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="index.html">KAVYA</a>
 ...
 <li><a class="app-menu__item" href="emmergency.php"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">EMMERGENCY REQUEST</span></a></li>
    ...
    <main class="app-content">
      ...
      <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">SEARCH NEARBY  SERVICE</h3>
            <div class="tile-body">
...
<option value="NULL">SELECT SERVICE TYPE</option>
			  ...
			  <option value="BLODDBANK">BLOOD BANK</option>
            </select>
                </div>
