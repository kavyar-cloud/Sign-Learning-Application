  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
     ...
     <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="appoinmentrequest.php" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Book appointment</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
      ...
      <div class="col-md-12">
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <!-- <option value="Bhubaneswar">Banglore</option> -->
              <option value="Bangalore">Bangalore</option>
              <option value="Mysore">Mysore</option>
              <option value="Hassan">Hassan</option>
              <option value="Brahmapur">Kolar</option>
               <option value="Puri">Mandya</option>
